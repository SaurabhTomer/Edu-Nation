  ...
  return (
    <div className='w-screen min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]'>
        <div className='w-full lg:w-[350px] lg:h-full h-[400px]  flex flex-col items-start justify-center gap-1 md:px-10  px-5'>
          ...
          <button className='px-5 py-2.5 border-2 bg-[black] border-white text-white rounded-2.5 text-[18px] font-light flex gap-2 mt-10' onClick={()=>navigate("/allcourses")}>Explore Courses <SiViaplay className='w-[30px] h-[30px] fill-white' /></button>
