...
function AllCourses() {
  ...
  // function to set category for which we select courses
  ...
  //function to filter courses of a category
  const applyFilter = () => {
  ...
  // hook run when ever change in courseData
  useEffect(() => {
    setFilterCourses(courseData);
  }, [courseData]);

  // hook run when ever change in category
  useEffect(() => {
    applyFilter();
  }, [category]);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        >
          <button
            className="px-2.5 py-2.5  bg-black text-white  rounded-2.5 text-[15px] font-light flex items-center justify-center gap-2 cursor-pointer"
